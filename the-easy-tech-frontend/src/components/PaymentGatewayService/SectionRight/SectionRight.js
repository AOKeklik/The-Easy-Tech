    ...
    >
        <div className='right pl-10'>
            <div className='bg-img'>
                <Image width={5000} height={5000} className='w-full' src={URL_IMG+"/gatewaytwo/"+data.data.image} alt='image' /> 
            </div>
            <div className='feature-item py-4 px-6 rounded-2xl bg-white inline-flex items-center gap-4 box-shadow'>
                ...
                <div className='text'>
                    <div className='heading7'>{data.data.project}</div>
            ...
            <div className='feature-item py-4 px-6 rounded-2xl bg-white inline-flex items-center gap-4 box-shadow'>
                ...
                <div className='text'>
                    <div className='heading7'>{data.data.review}</div>
            ...
            <div className='feature-item py-4 px-6 rounded-2xl bg-white inline-flex items-center gap-4 box-shadow'>
                ...
                <div className='text'>
                    <div className='heading7'>{data.data.experience}</div>
