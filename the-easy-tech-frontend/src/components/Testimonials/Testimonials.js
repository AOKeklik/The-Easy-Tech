...
const Testimonials = () => {
    return <div className='testimonial-block bg-slate-100'>
                ...
                <div className='content sm:w-2/3 w-[85%]'>
                    ...
                    >
                        <SwiperSlide className='lg:pb-24 pb-20'>
                            <div className='text-2xl font-medium text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis, quia.</div>
                            <div className='text-button text-center mt-5'>Lorem ipsum dolor sit.</div> 
                        </SwiperSlide>
