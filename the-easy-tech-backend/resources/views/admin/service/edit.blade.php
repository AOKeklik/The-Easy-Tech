                    ...
                    <div class="card-body">
                        <form data-app-form="service-store">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug" readonly value="{{ $service->slug }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="desc" name="desc" class="summernote form-control" rows="5" spellcheck="false">{{ $service->desc }}</textarea>
        ...
        $(document).ready(function(){
            ...
            async function handlerSubmit (e) {
                try {
                    ...
                    formData.append("service_id",form.find("#service_id").val())
