...
@push("scripts")
    <script>
        ...
        $(document).ready(function(){
            $(document)
                .on("click","[data-app-btn=signout-submit]",handlerSubmitSignout)


            async function handlerSubmitSignout (e) {
                try {
                    e.preventDefault()
                    ...
                    const submit=await submitSignout(formData)
            ...
            async function submitSignout(formData) {
                try {
                    await showOverlay()
                    await delay(1000)
