            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route("admin.blog.add.view") }}" class="btn btn-primary">Add</a>
                    </div><!-- end card header -->
                    <div class="card-body" data-app-section="blog-table">
...
@push("scripts")
    <script>
        $(document).ready(function(){
            $(document)
                .on("change","[data-app-btn=blog-status-update]",handlerStatusUpdate)
                .on("click","[data-app-btn=blog-delete]",handlerDelete)
            ...
            async function handlerStatusUpdate (e) {
                try {
                    ...
                    formData.append("blog_id",$(this).data("blog-id"))
            ...
            function fetchData(){
                $.ajax({
                    type:"GET",
                    url:"{{ route('admin.blog.table.view') }}",
                    success:function(res){
                        $("[data-app-section=blog-table]").html(res)
                        reloadJqueryPlugins ()
                    },
                    error: function(xhr) {
