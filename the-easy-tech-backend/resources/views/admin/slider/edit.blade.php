                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form data-app-form="slider-store">
                            <input type="hidden" id="slider_id" name="slider_id" value="{{ request("slider_id") }}">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="button_link" name="button_link" type="text" class="form-control" value="{{ $slider->button_link }}" aria-describedby="basic-addon3 basic-addon4">
