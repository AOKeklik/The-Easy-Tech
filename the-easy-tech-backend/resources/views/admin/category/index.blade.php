            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route("admin.category.add.view") }}" class="btn btn-primary">Add</a>
                    </div><!-- end card header -->
                    <div class="card-body" data-app-section="category-table">
...
@push("scripts")
    <script>
        $(document).ready(function(){
            $(document)
                .on("change","[data-app-btn=category-status-update]",handlerStatusUpdate)
                .on("click","[data-app-btn=category-delete]",handlerDelete)
            ...
            async function handlerStatusUpdate (e) {
                try {
                    ...
                    formData.append("category_id",$(this).data("category-id"))
            ...
            async function handlerDelete (e) {
                try {
                    ...
                    const update=await deleteCategory(formData)
            ...
            function fetchCartSidebar(){
                $.ajax({
                    type:"GET",
                    url:"{{ route('admin.category.table.view') }}",
                    success:function(res){
                        $("[data-app-section=category-table]").html(res)
                        reloadJqueryPlugins ()
                    },
                    error: function(xhr) {
